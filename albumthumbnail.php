<?php
$ignore = array( 'cgi-bin', '.', '..', '.svn','akcie','index.htm','.htaccess','.git' );

function dirList($directory, $filesonly=false)
    {
        $results = array();
...
function generate_album($album,$w,$h)
{
//     echo $album;
